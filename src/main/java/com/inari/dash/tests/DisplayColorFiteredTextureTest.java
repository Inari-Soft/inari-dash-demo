...
public class DisplayColorFiteredTextureTest extends GDXFFTestAdapter {
    ...
    public void initTest( FFContext context ) {
        ...
        GlobalData globalAssetData = new GlobalData();
        ...
        TextureAsset textureAsset = assetSystem
            .getAssetBuilder( TextureAsset.class )
                .set( TextureAsset.NAME, GameService.ORIGINAL_FONT_TEXTURE_KEY.name )
                .set( TextureAsset.ASSET_GROUP, GameService.ORIGINAL_FONT_TEXTURE_KEY.group )
        ...
        SpriteAsset spriteAsset = assetSystem
            .getAssetBuilder( SpriteAsset.class )
                ...
                .set( SpriteAsset.ASSET_GROUP, GameService.ORIGINAL_FONT_TEXTURE_KEY.group )
                .set( SpriteAsset.TEXTURE_ID, assetSystem.getAssetTypeKey( GameService.ORIGINAL_FONT_TEXTURE_KEY ).id )
                .set( SpriteAsset.TEXTURE_REGION, new Rectangle( 0, 0, globalAssetData.unitTextureWidth, globalAssetData.unitTextureHeight ) )
            .build();
        
        assetSystem.loadAssets( GameService.ORIGINAL_FONT_TEXTURE_KEY.group );
    ...
    private Map<Integer, Integer> createColorReplaceMap() {
        ...
        result.put( CaveData.CaveColors.BaseForegroundColor1.color, CaveData.CaveColors.LightGreen.color );
        result.put( CaveData.CaveColors.BaseForegroundColor2.color, CaveData.CaveColors.Brown.color );
        result.put( CaveData.CaveColors.BaseForegroundColor3.color, CaveData.CaveColors.Purple.color );
